...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post coaches_url, params: { coach: { apellido: @coach.apellido, ciudad_nacimiento: @coach.ciudad_nacimiento, nombre: @coach.nombre } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { apellido: @coach.apellido, ciudad_nacimiento: @coach.ciudad_nacimiento, nombre: @coach.nombre } }
