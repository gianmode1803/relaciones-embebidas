...
class CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country" do
    assert_difference('Country.count') do
      post countries_url, params: { country: { grupo: @country.grupo, nombre: @country.nombre } }
    end
  ...
  test "should update country" do
    patch country_url(@country), params: { country: { grupo: @country.grupo, nombre: @country.nombre } }
